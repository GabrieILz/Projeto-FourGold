...
namespace Projeto_FourGold.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(15, MinimumLength = 11, ErrorMessage = "O campo CPF deve ter no mínimo 11 caracteres.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TipoConta tipoConta = Input.Tipo;
                ...
                if (tipoConta == TipoConta.Corrente)
                {
                    ...
                    conta.Numero = rand.Next(0, 1000).ToString();
                    conta.Saldo = 0;
